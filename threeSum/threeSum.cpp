...
int main() {
    ...
    static_assert(
        R1::contains<util::value_list<int, 1, 2, 6>>,
        "Failure"
    );
    static_assert(
        R1::contains<util::value_list<int, 1, 3, 5>>,
        "Failure"
    );
    static_assert(
        R1::contains<util::value_list<int, 2, 3, 4>>,
        "Failure"
    );
    ...
    static_assert(
        R2::contains<util::value_list<int, 1, 2, 7>>,
        "Failure"
    );
    static_assert(
        R2::contains<util::value_list<int, 2, 3, 5>>,
        "Failure"
    );
    ...
    static_assert(
        R3::contains<util::value_list<int, 5, 8, -3>>,
        "Failure"
    );
    static_assert(
        R3::contains<util::value_list<int, 5, 7, -2>>,
        "Failure"
    );
    ...
    static_assert(
        R4::contains<util::value_list<int, -5, -2, 7>>,
        "Failure"
    );
    static_assert(
        R4::contains<util::value_list<int, -5, 0, 5>>,
        "Failure"
    );
    static_assert(
        R4::contains<util::value_list<int, -2, 0, 2>>,
        "Failure"
    );
